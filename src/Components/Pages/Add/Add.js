...
const Add = () => {
    return (
        <div className='text-center'>
            <form className='container row mx-auto py-4'>
                <span className='col-4 me-4 text-end fs-5 fw-bold'>Product name:</span><input className='col-8 w-50 mb-3 py-2 fs-4' type="text" /> <br />
                <span className='col-4 me-4 text-end fs-5 fw-bold'>Product price:</span><input className='col-8 w-50 mb-3 py-2 fs-4' type="number" placeholder='$'/> <br />
                ...
                <span className='col-4 me-4 text-end fs-5 fw-bold'>Product image:</span><input className='col-8 w-50 mb-3 py-2 fs-4' type="url" placeholder='https://' /> <br />
                <span className='col-4 me-4 text-end fs-5 fw-bold'>Product quantity:</span><input className='col-8 w-50 mb-3 py-2 fs-4' type="number" placeholder='00'/> <br />
