...
const Footer = () => {
  return (
    <div className="text-white bg-dark p-4 container-fluid">
      <div className="row">
        <div className="col-md-6 col-sm-12 col-lg-4 text-center text-lg-start">
       <h1 >East<span className="text-green">wood</span></h1> 
       <h5 className="mt-5">Find more</h5>
       <div className="bg-white w-75 rounded-pill mx-auto mx-lg-0">
       ...
       <button className="text-dark border-0 w-25 rounded-pill py-2">Search</button>
        ...
        <div className="col-md-6 col-sm-12 col-lg-2">
                  ...
                  <ul className="d-flex list-unstyled justify-content-lg-around justify-content-center">
                      <li className="me-3 me-lg-0"><Icon className="fs-3" icon="akar-icons:google-fill" /></li>
                      <li className="me-3 me-lg-0"><Icon className="fs-3" icon="bi:facebook" /></li>
                      <li className="me-3 me-lg-0"><Icon className="fs-3" icon="cib:twitter" /></li>
                  </ul>
            </div>
        <div className="col-md-6 col-sm-12 col-lg-2">
